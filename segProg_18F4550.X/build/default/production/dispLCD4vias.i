...
volatile LCDbits_t LCDbits __attribute__((address(0x0F8A)));
# 101 "dispLCD4vias.c"
void dispLCD_instReg( unsigned char i )
{
    LCDbits.RS = 0;
...
void dispLCD_lincol( unsigned char lin, unsigned char col)
{
    ...
    switch(lin)
    {
        case 1: aux = 0x40; break;
        case 2: aux = 0x14; break;
        case 3: aux = 0x54; break;
    }

    dispLCD_instReg( (0x80+(aux + (col + 0x00) & 0x7F)) );
}
