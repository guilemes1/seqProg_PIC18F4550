...
struct eusartT
{
    ...
    unsigned char (*rxSTATUS)( void );
    unsigned char (*rxERROR)( void );
    void (* rxResetERROR) ( void );
    void (* tx)( unsigned char d );
    unsigned char (* txSTATUS) ( void );
            ...
            case 71:
             ...
             case 84:
                            ...
                            switch(tecla)
                            {
                                ...
                                case '*': dispLCD_clr(); estado = 80; break;
                            }
                            break;
             ...
             case 73:
                            ...
                            switch(tecla)
                            {
                                ...
                                case '8':
                                case '9':
                                           buscar_dado(10, tecla % 0x30, &init_cond);
                                           manipula_atuadores_init(init_cond);

                                           EEPROM.buscar(tecla % 0x30, vetor_aux);
                                           pt = vetor_aux;
